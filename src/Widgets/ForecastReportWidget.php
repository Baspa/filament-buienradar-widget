...
class ForecastReportWidget extends Widget
{
    public ?array $forecast = null;

    protected static string $view = 'filament-buienradar-widget::widgets.forecast-report';
    ...
    public function mount(): void
    {
        ...
        $this->forecast = $buienradar->forecast()->report();
    }
}
